...
export const CARD_PLAYERS: CardPlayer[] = [
  ...
  ...makeTeamCards("Geelong", "cats", [
    "baileysmith", "bradclose", "connorosullivan", "georgestevens", "gryanmiers", "harleybarker", "hunterholmes", "jackbowes", "jackhenry", "jackmartin", "jacobmolier", "jakekolodjashnij", "jamesworpel", "jaypolkinghorne", "jedbews", "jeremycameron", "jessemellor", "jhyeclark", "joepike", "keightonmatofaiforbes", "lawsonhumphries", "lennoxhoffman", "markblicavs", "markoconnor", "maxholmes", "mitchknevitt", "mitchelledwards", "nickdriscoll", "oisinmullin", "oliverhenry", "oliverwiltshire", "patrickdangerfield", "rhysstanley", "samdekoning", "shannonneale", "shaunmannagh", "tannerbruhn", "tobyconway", "tomatkins", "tomstewart", "tysonstengle", "zachguthrie",
  ]),
  ...makeTeamCards("Hawthorn", "hawks", [
    "aidanschubert", "baileymacdonald", "blakehardwick", "brodieryan", "calsherdear", "cammackenzie", "cameronnairn", "codyanderson", "connormacdonald", "conornash", "dylanmoore", "finnmaginness", "flynnperez", "harrymorrison", "henryhustwaite", "jackdalton", "jackginnivan", "jackgunston", "jackscrimshaw", "jainewcombe", "jamesblanck", "jamessicily", "jaimeuhrhenry", "jarmanimpey", "joshbattle", "joshward", "joshweddle", "karlamon", "lloydmeek", "mabiorchol", "massimodambrosio", "matthill", "matthewleray", "maxramsden", "mitchlewis", "nedreeves", "nickwatson", "noahmraz", "olliegreeves", "sambutler", "tombarrass", "willday", "williammccabe",
  ]),
  ...makeTeamCards("Melbourne", "demons", [
    "aidanjohnson", "andymonizwakefield", "baileylaurie", "bayleyfritsch", "blakehowes", "brodymihocek", "calebwindsor", "changkuothjiath", "christiansalem", "danielturner", "edlangdon", "harrisonpetty", "harrysharp", "harveylangford", "jackhenderson", "jacksteele", "jackviney", "jacobvanrooyen", "jaiculley", "jakebowey", "jakelever", "jakemelksham", "jedadams", "kadechandler", "kalaniwhite", "koltyntholstrup", "kysaiahpickett", "latrellepickett", "lukerkentfield", "matthewjefferson", "maxgawn", "maxheath", "oscarberry", "paddycross", "rickymentha", "rileyonley", "shanemcadam", "thomasmatthews", "tomcampbell", "tommcdonald", "tomsparrow", "trentrivers", "xavierlindsay", "xaviertaylor",
  ]),
  ...
  ...makeTeamCards("Gold Coast", "suns", [
    "alexdavies", "ashereastham", "averythomas", "baileyhumphrey", "beauaddinsall", "benjepson", "benking", "benlong", "bodhiuwland", "calebgraham", "caleblewis", "charlieballard", "cooperbell", "danielrioli", "dylanpatterson", "elliotthimmelberg", "ethanread", "jaimurray", "jakerogers", "jarrodwitts", "jedwalter", "joeljeffrey", "johnnoble", "jyfarrar", "kobycoulson", "lachieweller", "lachlangulbin", "leonardolombard", "macandrew", "mattrowell", "maxknobel", "nedmoyle", "nickholman", "noahanderson", "oscaradams", "samclohesy", "samcollins", "toukmiller", "wilpowell", "willgraham", "zakevans", "zekeuwland",
  ]),
