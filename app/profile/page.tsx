...
// The header styles reference these vars via calc(), so the browser does the
...
export default function ProfilePage() {
  ...
  const expandedOnlyOpacity = `clamp(0, calc(1 - ${HP} * 1.35), 1)`;
            ...
            >
              <div style={bannerFrameStyle}>
                {bannerSrc ? (
                  ...
                  <div className="profile-banner-media" style={{ ...bannerMediaStyle, background: bannerStyle.background }} />
                )}
