...
function MatchComments({ gameId, highlight }: { gameId: number; highlight: string | null }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "calc(100dvh - 108px)" }}>
      ...
      {/* Comments list */}
      <div style={{ flex: 1, overflowY: "auto", minHeight: 0, padding: "10px 0 4px" }}>
        {loading ? (
      ...
      <div style={{ flexShrink: 0, zIndex: 50, borderTop: "1px solid var(--border-2)", padding: "10px 14px calc(14px + env(safe-area-inset-bottom))", background: "var(--bottom-nav-bg)", backdropFilter: "blur(20px)", WebkitBackdropFilter: "blur(20px)" }}>
        {!userId ? (
